      ...
      <nav className="w-full bg-[#5A1E2C] text-white px-10 py-5 shadow-xl">
        <div className="w-full flex justify-between items-center">
          ...
          <div className="flex items-center gap-10 text-xl">
            ...
            <a href="/mansion" className="hover:text-pink-200">The Mansion</a>
          ...
          <div className="bg-white rounded-3xl shadow-2xl p-8">
            ...
            {!submitted ? (
              <>
                ...
                <div className="grid gap-4">
                  <input
                    ...
                    className="w-full p-4 border border-[#d8a7b1] rounded-xl text-black"
                  />
                  ...
                  <button
                    ...
                    className="bg-[#7A3243] text-white p-4 rounded-xl text-lg hover:bg-[#5A1E2C] shadow-lg transition"
                  >
                    Send Enquiry
                  </button>
                </div>
              ...
              <div className="text-center py-16">
                ...
                <h2
                  className="text-4xl text-[#5A1E2C] mb-5"
                  style={{ fontFamily: "Georgia, serif" }}
                >
                  Thank You!
                </h2>
